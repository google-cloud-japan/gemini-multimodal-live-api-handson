...
gcloud beta iap web add-iam-policy-binding --member "user:${account}" --role "roles/iap.httpsResourceAccessor" --resource-type "cloud-run" --service genai-app-04 --region asia-northeast1
```
